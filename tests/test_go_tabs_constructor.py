...
class TestTabsContructor:
    def test_go_to_tab_toppings(self, driver,authorization):
        ...
        WebDriverWait(driver,10).until(expected_conditions.visibility_of_element_located((TestLocators.CHECK_OF_TOPPINGS)))
    ...
    def test_go_to_tab_souses(self, driver,authorization):
        ...
        WebDriverWait(driver,10).until(expected_conditions.visibility_of_element_located((TestLocators.CHECK_OF_OF_SAUCE)))
    ...
    def test_go_to_tab_buns(self, driver,authorization):
        ...
        WebDriverWait(driver,3).until(expected_conditions.visibility_of_element_located((TestLocators.CHECK_OF_BUNS)))
